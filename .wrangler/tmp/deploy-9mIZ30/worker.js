...
__name(handleCurrencyAPI, "handleCurrencyAPI");
...
__name(handleTemperatureConvert, "handleTemperatureConvert");
...
__name(handleLengthConvert, "handleLengthConvert");
function handleCORS() {
...
function addSecurityHeaders(response, url) {
  ...
  const isHtmlDocument = contentType.includes("text/html") || !isStaticAsset && !url.pathname.startsWith("/api/");
...
__name(pathnameHasStaticAssetExtension, "pathnameHasStaticAssetExtension");
export {
  addSecurityHeaders,
