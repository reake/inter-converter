                  ...
                  <CardContent>
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        ...
                        <span>Hold investments more than 1 year for long-term rates</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-green-600 font-bold">•</span>
                      ...
                      {holdingPeriod === 'short' && (
                        <div className="p-3 bg-yellow-50 rounded-lg">
                          ...
                          <div className="text-yellow-700 text-sm">
                            Holding for more than 1 year could save you {formatCurrency(results.federalTax - (results.capitalGain * (parseFloat(annualIncome) > 44625 ? 0.15 : 0)))} in federal taxes.
                          </div>
                        </div>
                      )}
            ...
            <TabsContent value="rates" className="space-y-4">
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-semibold mb-3 text-green-800">Long-term Capital Gains (over 1 year)</h4>
