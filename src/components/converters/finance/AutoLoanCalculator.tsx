...
export default function AutoLoanCalculator() {
  ...
  const getInterestRateByCredit = (score: string) => {
    const rates = {
      ...
      'near-prime': '6.5-10.0',
      'subprime': '10.0-15.0',
      'deep-subprime': '15.0-20.0+'
    };
    return rates[score as keyof typeof rates] || '4.5-6.5';
  };
    ...
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Calculate your car loan payments, total interest, and find the best financing options. 
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <Card className="h-fit">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="carPrice" className="text-base font-medium">Car Price</Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="downPayment" className="text-base font-medium">Trade-In Value / Down Payment</Label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500 text-lg">$</span>
                <Input
                  id="downPayment"
            ...
            <CardContent className="space-y-6">
              ...
              <div className="border-t pt-4 space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">{formatCurrency(parseFloat(carPrice))}</span>
                </div>
                <div className="flex justify-between">
                ...
                {parseFloat(tradeInValue) > 0 && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">-{formatCurrency(parseFloat(tradeInValue))}</span>
                  </div>
                )}
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-xl font-bold">Auto Loan Tips</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-semibold text-green-700 mb-2">💡 Money-Saving Tips</h3>
            ...
            <div>
              <h3 className="font-semibold text-blue-700 mb-2">📊 Loan Term Comparison</h3>
              <ul className="text-sm space-y-1 text-gray-600">
                <li>• 36 months: Higher payments, less interest</li>
                <li>• 48 months: Balanced option</li>
                <li>• 60 months: Popular choice</li>
                <li>• 72+ months: Lower payments, more interest</li>
              </ul>
            </div>
          </div>
        </CardContent>
