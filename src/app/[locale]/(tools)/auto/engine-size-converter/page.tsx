...
export async function generateMetadata({
  ...
  const entry = getEntry('engine-size-converter');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/auto/engine-size-converter`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/auto/engine-size-converter',
        zh: '/zh/auto/engine-size-converter'
      }
    },
...
export default async function EngineSizeConverterPage({
  ...
  const entry = catalog.find((it) => it.id === 'engine-size-converter') || (autoEn as any[]).find((it) => it.id === 'engine-size-converter');
