...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'kg-to-pounds-converter') || catalogs.en.find((it) => it.id === 'kg-to-pounds-converter');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/unit/kg-to-pounds-converter`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/unit/kg-to-pounds-converter',
        zh: '/zh/unit/kg-to-pounds-converter'
      }
    },
