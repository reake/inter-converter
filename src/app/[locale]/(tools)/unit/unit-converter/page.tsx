...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'unit-converter') || catalogs.en.find((it) => it.id === 'unit-converter');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/unit/unit-converter`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/unit/unit-converter',
        zh: '/zh/unit/unit-converter'
      }
    },
