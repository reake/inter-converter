...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'weight-converter') || catalogs.en.find((it) => it.id === 'weight-converter');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/unit/weight-converter`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/unit/weight-converter',
        zh: '/zh/unit/weight-converter'
      }
    },
