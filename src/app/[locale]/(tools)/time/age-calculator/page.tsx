...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'age-calculator') || catalogs.en.find((it) => it.id === 'age-calculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/time/age-calculator`;
