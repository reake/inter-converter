...
import enTool from '@/data/tools/finance/bitcoin-calculator-en.json';
import zhTool from '@/data/tools/finance/bitcoin-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'bitcoin-calculator') || catalogs.en.find((it) => it.id === 'bitcoin-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('bitcoin-calculator', 'finance', 'CurrencyConverter');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/bitcoin-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/bitcoin-calculator',
        zh: '/zh/finance/bitcoin-calculator'
      }
    },
