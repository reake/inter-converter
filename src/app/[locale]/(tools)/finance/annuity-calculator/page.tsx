...
import enTool from '@/data/tools/finance/annuity-calculator-en.json';
import zhTool from '@/data/tools/finance/annuity-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'annuity-calculator') || catalogs.en.find((it) => it.id === 'annuity-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('annuity-calculator', 'finance', 'SavingsCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/annuity-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/annuity-calculator',
        zh: '/zh/finance/annuity-calculator'
      }
    },
