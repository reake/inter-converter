...
import enTool from '@/data/tools/finance/payday-loan-calculator-en.json';
import zhTool from '@/data/tools/finance/payday-loan-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'payday-loan-calculator') || catalogs.en.find((it) => it.id === 'payday-loan-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('payday-loan-calculator', 'finance', 'LoanCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/payday-loan-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/payday-loan-calculator',
        zh: '/zh/finance/payday-loan-calculator'
      }
    },
