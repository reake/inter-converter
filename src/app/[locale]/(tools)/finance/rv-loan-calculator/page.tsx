...
import enTool from '@/data/tools/finance/rv-loan-calculator-en.json';
import zhTool from '@/data/tools/finance/rv-loan-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'rv-loan-calculator') || catalogs.en.find((it) => it.id === 'rv-loan-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('rv-loan-calculator', 'finance', 'LoanCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/rv-loan-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/rv-loan-calculator',
        zh: '/zh/finance/rv-loan-calculator'
      }
    },
