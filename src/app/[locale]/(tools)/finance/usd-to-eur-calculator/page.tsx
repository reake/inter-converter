...
import enTool from '@/data/tools/finance/usd-to-eur-calculator-en.json';
import zhTool from '@/data/tools/finance/usd-to-eur-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'usd-to-eur-calculator') || catalogs.en.find((it) => it.id === 'usd-to-eur-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('usd-to-eur-calculator', 'finance', 'CurrencyConverter');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/usd-to-eur-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/usd-to-eur-calculator',
        zh: '/zh/finance/usd-to-eur-calculator'
      }
    },
