...
import enTool from '@/data/tools/finance/home-insurance-calculator-en.json';
import zhTool from '@/data/tools/finance/home-insurance-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'home-insurance-calculator') || catalogs.en.find((it) => it.id === 'home-insurance-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('home-insurance-calculator', 'finance', 'InsuranceCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/home-insurance-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/home-insurance-calculator',
        zh: '/zh/finance/home-insurance-calculator'
      }
    },
