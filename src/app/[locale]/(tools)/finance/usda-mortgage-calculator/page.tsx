...
import enTool from '@/data/tools/finance/usda-mortgage-calculator-en.json';
import zhTool from '@/data/tools/finance/usda-mortgage-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'usda-mortgage-calculator') || catalogs.en.find((it) => it.id === 'usda-mortgage-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('usda-mortgage-calculator', 'finance', 'MortgageCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/usda-mortgage-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/usda-mortgage-calculator',
        zh: '/zh/finance/usda-mortgage-calculator'
      }
    },
