...
import enTool from '@/data/tools/finance/boat-loan-calculator-en.json';
import zhTool from '@/data/tools/finance/boat-loan-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'boat-loan-calculator') || catalogs.en.find((it) => it.id === 'boat-loan-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('boat-loan-calculator', 'finance', 'LoanCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/boat-loan-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/boat-loan-calculator',
        zh: '/zh/finance/boat-loan-calculator'
      }
    },
