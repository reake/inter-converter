...
import enTool from '@/data/tools/finance/ira-calculator-en.json';
import zhTool from '@/data/tools/finance/ira-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'ira-calculator') || catalogs.en.find((it) => it.id === 'ira-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('ira-calculator', 'finance', 'RetirementCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/ira-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/ira-calculator',
        zh: '/zh/finance/ira-calculator'
      }
    },
