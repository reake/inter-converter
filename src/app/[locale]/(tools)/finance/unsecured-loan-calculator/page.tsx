...
import enTool from '@/data/tools/finance/unsecured-loan-calculator-en.json';
import zhTool from '@/data/tools/finance/unsecured-loan-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'unsecured-loan-calculator') || catalogs.en.find((it) => it.id === 'unsecured-loan-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('unsecured-loan-calculator', 'finance', 'LoanCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/unsecured-loan-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/unsecured-loan-calculator',
        zh: '/zh/finance/unsecured-loan-calculator'
      }
    },
