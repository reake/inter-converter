...
export async function generateMetadata({
  ...
  const entry = getLocalizedToolEntry(l, 'credit-utilization-calculator', financeEn as ToolCatalogEntry[], financeZh as ToolCatalogEntry[]);
  ...
  return buildToolPageMetadata({
    ...
    description,
    keywords,
    path: '/finance/credit-utilization-calculator'
  });
}
