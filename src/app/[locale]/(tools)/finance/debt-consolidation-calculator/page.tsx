...
import enTool from '@/data/tools/finance/debt-consolidation-calculator-en.json';
import zhTool from '@/data/tools/finance/debt-consolidation-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'debt-consolidation-calculator') || catalogs.en.find((it) => it.id === 'debt-consolidation-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('debt-consolidation-calculator', 'finance', 'DebtCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/debt-consolidation-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/debt-consolidation-calculator',
        zh: '/zh/finance/debt-consolidation-calculator'
      }
    },
