...
import enTool from '@/data/tools/finance/mortgage-refinance-calculator-en.json';
import zhTool from '@/data/tools/finance/mortgage-refinance-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'mortgage-refinance-calculator') || catalogs.en.find((it) => it.id === 'mortgage-refinance-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('mortgage-refinance-calculator', 'finance', 'MortgageCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/mortgage-refinance-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/mortgage-refinance-calculator',
        zh: '/zh/finance/mortgage-refinance-calculator'
      }
    },
