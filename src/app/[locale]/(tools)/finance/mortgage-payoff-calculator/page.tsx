...
import enTool from '@/data/tools/finance/mortgage-payoff-calculator-en.json';
import zhTool from '@/data/tools/finance/mortgage-payoff-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'mortgage-payoff-calculator') || catalogs.en.find((it) => it.id === 'mortgage-payoff-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('mortgage-payoff-calculator', 'finance', 'MortgageCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/mortgage-payoff-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/mortgage-payoff-calculator',
        zh: '/zh/finance/mortgage-payoff-calculator'
      }
    },
