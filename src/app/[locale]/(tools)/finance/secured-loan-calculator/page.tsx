...
import enTool from '@/data/tools/finance/secured-loan-calculator-en.json';
import zhTool from '@/data/tools/finance/secured-loan-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'secured-loan-calculator') || catalogs.en.find((it) => it.id === 'secured-loan-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('secured-loan-calculator', 'finance', 'LoanCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/secured-loan-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/secured-loan-calculator',
        zh: '/zh/finance/secured-loan-calculator'
      }
    },
