...
import enTool from '@/data/tools/finance/student-loan-calculator-en.json';
import zhTool from '@/data/tools/finance/student-loan-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'student-loan-calculator') || catalogs.en.find((it) => it.id === 'student-loan-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('student-loan-calculator', 'finance', 'LoanCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/student-loan-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/student-loan-calculator',
        zh: '/zh/finance/student-loan-calculator'
      }
    },
