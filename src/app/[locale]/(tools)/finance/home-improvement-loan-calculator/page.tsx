...
import enTool from '@/data/tools/finance/home-improvement-loan-calculator-en.json';
import zhTool from '@/data/tools/finance/home-improvement-loan-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'home-improvement-loan-calculator') || catalogs.en.find((it) => it.id === 'home-improvement-loan-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('home-improvement-loan-calculator', 'finance', 'LoanCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/home-improvement-loan-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/home-improvement-loan-calculator',
        zh: '/zh/finance/home-improvement-loan-calculator'
      }
    },
