...
import enTool from '@/data/tools/finance/etf-calculator-en.json';
import zhTool from '@/data/tools/finance/etf-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'etf-calculator') || catalogs.en.find((it) => it.id === 'etf-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('etf-calculator', 'finance', 'InvestmentCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/etf-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/etf-calculator',
        zh: '/zh/finance/etf-calculator'
      }
    },
