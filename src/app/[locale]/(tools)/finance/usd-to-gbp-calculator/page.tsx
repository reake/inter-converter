...
import enTool from '@/data/tools/finance/usd-to-gbp-calculator-en.json';
import zhTool from '@/data/tools/finance/usd-to-gbp-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'usd-to-gbp-calculator') || catalogs.en.find((it) => it.id === 'usd-to-gbp-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('usd-to-gbp-calculator', 'finance', 'CurrencyConverter');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/usd-to-gbp-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/usd-to-gbp-calculator',
        zh: '/zh/finance/usd-to-gbp-calculator'
      }
    },
