...
import enTool from '@/data/tools/finance/loan-calculator-en.json';
import zhTool from '@/data/tools/finance/loan-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = getLocalizedToolEntry(l, 'loan-calculator', financeEn as ToolCatalogEntry[], financeZh as ToolCatalogEntry[]);
...
export default async function LoanCalculatorPage({
  ...
  const toolName: string = entry?.name || 'Loan Calculator';
  const descriptionText: string = entry?.description || 'Calculate monthly payments, total interest costs, and amortization schedules for any type of loan.';
  const baseKeywords = generateOptimizedKeywords('loan-calculator', 'finance', 'Loan Calculator');
