...
import enTool from '@/data/tools/finance/payroll-tax-calculator-en.json';
import zhTool from '@/data/tools/finance/payroll-tax-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'payroll-tax-calculator') || catalogs.en.find((it) => it.id === 'payroll-tax-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('payroll-tax-calculator', 'finance', 'TaxCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/payroll-tax-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/payroll-tax-calculator',
        zh: '/zh/finance/payroll-tax-calculator'
      }
    },
