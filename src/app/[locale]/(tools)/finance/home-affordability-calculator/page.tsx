...
import enTool from '@/data/tools/finance/home-affordability-calculator-en.json';
import zhTool from '@/data/tools/finance/home-affordability-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'home-affordability-calculator') || catalogs.en.find((it) => it.id === 'home-affordability-calculator');

  const toolName: string = entry?.name ?? 'HomeAffordabilityCalculator';
  const description: string = entry?.description ?? 'Professional financial calculator for accurate calculations and planning.';
  const baseKeywords = generateOptimizedKeywords('home-affordability-calculator', 'finance', 'HomeAffordabilityCalculator');
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/home-affordability-calculator',
        zh: '/zh/finance/home-affordability-calculator'
      }
    },
