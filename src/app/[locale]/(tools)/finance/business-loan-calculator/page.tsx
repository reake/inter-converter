...
import enTool from '@/data/tools/finance/business-loan-calculator-en.json';
import zhTool from '@/data/tools/finance/business-loan-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'business-loan-calculator') || catalogs.en.find((it) => it.id === 'business-loan-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('business-loan-calculator', 'finance', 'LoanCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/business-loan-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/business-loan-calculator',
        zh: '/zh/finance/business-loan-calculator'
      }
    },
