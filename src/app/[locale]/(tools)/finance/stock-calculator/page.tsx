...
import enTool from '@/data/tools/finance/stock-calculator-en.json';
import zhTool from '@/data/tools/finance/stock-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'stock-calculator') || catalogs.en.find((it) => it.id === 'stock-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('stock-calculator', 'finance', 'InvestmentCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/stock-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/stock-calculator',
        zh: '/zh/finance/stock-calculator'
      }
    },
