...
import enTool from '@/data/tools/finance/equipment-loan-calculator-en.json';
import zhTool from '@/data/tools/finance/equipment-loan-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'equipment-loan-calculator') || catalogs.en.find((it) => it.id === 'equipment-loan-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('equipment-loan-calculator', 'finance', 'LoanCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/equipment-loan-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/equipment-loan-calculator',
        zh: '/zh/finance/equipment-loan-calculator'
      }
    },
