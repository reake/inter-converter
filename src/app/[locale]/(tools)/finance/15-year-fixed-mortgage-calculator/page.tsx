...
import enTool from '@/data/tools/finance/15-year-fixed-mortgage-calculator-en.json';
import zhTool from '@/data/tools/finance/15-year-fixed-mortgage-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === '15-year-fixed-mortgage-calculator') || catalogs.en.find((it) => it.id === '15-year-fixed-mortgage-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('15-year-fixed-mortgage-calculator', 'finance', 'MortgageCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/15-year-fixed-mortgage-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/15-year-fixed-mortgage-calculator',
        zh: '/zh/finance/15-year-fixed-mortgage-calculator'
      }
    },
