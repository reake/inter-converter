...
import enTool from '@/data/tools/finance/property-tax-calculator-en.json';
import zhTool from '@/data/tools/finance/property-tax-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'property-tax-calculator') || catalogs.en.find((it) => it.id === 'property-tax-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('property-tax-calculator', 'finance', 'TaxCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/property-tax-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/property-tax-calculator',
        zh: '/zh/finance/property-tax-calculator'
      }
    },
