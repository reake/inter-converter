...
import enTool from '@/data/tools/finance/consolidation-loan-calculator-en.json';
import zhTool from '@/data/tools/finance/consolidation-loan-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'consolidation-loan-calculator') || catalogs.en.find((it) => it.id === 'consolidation-loan-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('consolidation-loan-calculator', 'finance', 'LoanCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/consolidation-loan-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/consolidation-loan-calculator',
        zh: '/zh/finance/consolidation-loan-calculator'
      }
    },
