...
import enTool from '@/data/tools/finance/title-loan-calculator-en.json';
import zhTool from '@/data/tools/finance/title-loan-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'title-loan-calculator') || catalogs.en.find((it) => it.id === 'title-loan-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('title-loan-calculator', 'finance', 'LoanCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/title-loan-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/title-loan-calculator',
        zh: '/zh/finance/title-loan-calculator'
      }
    },
