...
import enTool from '@/data/tools/finance/cash-out-refinance-calculator-en.json';
import zhTool from '@/data/tools/finance/cash-out-refinance-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'cash-out-refinance-calculator') || catalogs.en.find((it) => it.id === 'cash-out-refinance-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('cash-out-refinance-calculator', 'finance', 'MortgageCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/cash-out-refinance-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/cash-out-refinance-calculator',
        zh: '/zh/finance/cash-out-refinance-calculator'
      }
    },
