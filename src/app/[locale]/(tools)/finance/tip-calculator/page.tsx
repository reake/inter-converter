...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'tip-calculator') || catalogs.en.find((it) => it.id === 'tip-calculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/tip-calculator`;
