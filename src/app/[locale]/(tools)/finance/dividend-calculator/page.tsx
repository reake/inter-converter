...
import enTool from '@/data/tools/finance/dividend-calculator-en.json';
import zhTool from '@/data/tools/finance/dividend-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'dividend-calculator') || catalogs.en.find((it) => it.id === 'dividend-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('dividend-calculator', 'finance', 'InvestmentCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/dividend-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/dividend-calculator',
        zh: '/zh/finance/dividend-calculator'
      }
    },
