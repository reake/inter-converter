...
import enTool from '@/data/tools/finance/credit-card-payoff-calculator-en.json';
import zhTool from '@/data/tools/finance/credit-card-payoff-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'credit-card-payoff-calculator') || catalogs.en.find((it) => it.id === 'credit-card-payoff-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('credit-card-payoff-calculator', 'finance', 'CreditCardPayoffCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/credit-card-payoff-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/credit-card-payoff-calculator',
        zh: '/zh/finance/credit-card-payoff-calculator'
      }
    },
