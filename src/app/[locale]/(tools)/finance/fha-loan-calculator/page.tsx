...
import enTool from '@/data/tools/finance/fha-loan-calculator-en.json';
import zhTool from '@/data/tools/finance/fha-loan-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'fha-loan-calculator') || catalogs.en.find((it) => it.id === 'fha-loan-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('fha-loan-calculator', 'finance', 'MortgageCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/fha-loan-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/fha-loan-calculator',
        zh: '/zh/finance/fha-loan-calculator'
      }
    },
