...
import enTool from '@/data/tools/finance/income-tax-calculator-en.json';
import zhTool from '@/data/tools/finance/income-tax-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'income-tax-calculator') || catalogs.en.find((it) => it.id === 'income-tax-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('income-tax-calculator', 'finance', 'TaxCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/income-tax-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/income-tax-calculator',
        zh: '/zh/finance/income-tax-calculator'
      }
    },
