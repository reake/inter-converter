...
import enTool from '@/data/tools/finance/emergency-fund-calculator-en.json';
import zhTool from '@/data/tools/finance/emergency-fund-calculator-zh.json';
...
export async function generateMetadata({
  ...
  const entry = catalogs[l]?.find((it) => it.id === 'emergency-fund-calculator') || catalogs.en.find((it) => it.id === 'emergency-fund-calculator');
  ...
  const baseKeywords = generateOptimizedKeywords('emergency-fund-calculator', 'finance', 'SavingsCalculator');
  ...
  const canonicalPath = `${l === "en" ? "" : "/" + l}/finance/emergency-fund-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: '/finance/emergency-fund-calculator',
        zh: '/zh/finance/emergency-fund-calculator'
      }
    },
